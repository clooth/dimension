...
(function (Dimension) {
    var Player = (function (_super) {
        ...
        Player.prototype.isHandFull = function () {
            return (this.hand.size() >= Dimension.Game.MAXIMUM_HAND_SIZE);
        };
        Player.prototype.handleFullHand = function () {
        };

        Player.prototype.isBoardFull = function () {
            return (this.board.length >= Dimension.Game.MAXIMUM_BOARD_SIZE);
        };
...
(function (Dimension) {
    ...
    var Game = (function () {
        function Game() {
            ...
            this.targetFilters = {};
            this.targetFilters[0 /* HERO */] = function (game) {
                return (this instanceof Dimension.Player);
            };
            this.targetFilters[1 /* MINION */] = function (game) {
                return (this instanceof Dimension.Minion);
            };
            this.targetFilters[2 /* ENEMY_HERO */] = function (game) {
                return (this instanceof Dimension.Player) && (this != game.currentPlayer());
            };
            this.targetFilters[3 /* ENEMY_MINION */] = function (game) {
                return (this instanceof Dimension.Minion) && (this.controller != game.currentPlayer());
            };
            this.targetFilters[4 /* FRIENDLY_HERO */] = function (game) {
                return (this instanceof Dimension.Player) && (this.controller == game.currentPlayer());
            };
            this.targetFilters[5 /* FRIENDLY_MINION */] = function (game) {
                return (this instanceof Dimension.Minion) && (this.controller == game.currentPlayer());
            };
            this.targetFilters[8 /* CHARACTER */] = function (game) {
                return (self.filter(this, 0 /* HERO */) || self.filter(this, 1 /* MINION */));
            };
            this.targetFilters[9 /* DAMAGED */] = function (game) {
                return this.isDamaged();
            };
        }
        Game.prototype.filter = function (self, filt) {
